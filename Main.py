...
def load_data():
    df_train=read_file('/home/murdizm/Desktop/Prediction_Final/eth/train/biwi_hotel_train.txt')
    df_test=read_file('/home/murdizm/Desktop/Prediction_Final/eth/test/biwi_eth.txt')
...
# used by divide_time_series to create a sequence                   
def sequence (start,limit,num_of_points): 
                    
                # Check is the number of coordinates is enough to create a sequence
                if ((start + num_of_points) <= limit):  

                        # create a sequence of 'num_of_points' coordinates ,
                        # i.e if num_of_points is 3 , 3 points are used to create a sequence 

                        for k in range (2*num_of_points):
                            pass
                            
def divide_time_series(df,input_points,output_points): 
...
# load_Data
array_train,array_test=load_data()
