...
def load_data():
    df_train=read_file('zara1/train/crowds_zara02_train.txt')
    df_validate=read_file('zara1/val/crowds_zara02_val.txt')
    df_test=read_file('zara1/test/crowds_zara01.txt')
...
def save_pickle():
    with open('train_input.pickle', 'wb') as output:
        pickle.dump(train_input, output)
    with open('validate_input.pickle', 'wb') as output:
        pickle.dump(validate_input, output)
    with open('test_input.pickle', 'wb') as output:
        pickle.dump(test_input, output)
    with open('train_target.pickle', 'wb') as output:
        pickle.dump(train_target, output)
    with open('validate_target.pickle', 'wb') as output:
        pickle.dump(validate_target, output)
    with open('test_target.pickle', 'wb') as output:
        pickle.dump(test_target, output)
